...
SlideDeck.prototype.loadConfig_ = function(config) {
  ...
  if (settings.title) {
    document.title = settings.title.replace(/<br\/?>/, ' ') + ' - HTML5 Denver 2013';
  ...
  if (this.config_.presenters) {
    ...
    if (presenters.length == 1) {
      ...
      var linkedin = p.linkedin ? '<span>linkedin</span><a href="' + p.linkedin +
      ...
      var html2 = [gplus, twitter, www, github, linkedin].join('<br>');
